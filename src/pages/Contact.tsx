...
export default function Contact() {
  return (
    <>
      <SEOHead
        title="Contact"
        description={`Get in touch with ${photographerInfo.name} for AI/ML consulting, Voice AI projects, and collaboration opportunities.`}
      />
              ...
              >
                <div className="space-y-3">
                  ...
                  <p className="text-muted-foreground font-light">
                    Fill out the form below and I'll get back to you within 24-48 hours. Currently available for new opportunities.
                  </p>
                </div>
